...
impl Wallet {
    ...
    pub fn apply_block_connected_to(
        ...
        println!("Starting to apply block at height {}", height);
        ...
        println!("Finished applying header for block at height {}", height);
        changeset.merge(
            self.indexed_graph
                .apply_block_relevant(block, height)
                .into(),
        );
        println!("Finished applying block at height {}", height);
        self.stage.merge(changeset);
        println!("Staged changes for block at height {}", height);
        Ok(())
    }
